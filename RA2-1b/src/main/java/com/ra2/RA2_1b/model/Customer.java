...
public class Customer {
    private long id;
    private String name, description, course, password;
    private int age;
    ...
    public Customer(long id, String name, String description, int age, String course, String password) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        ...
        return String.format(
                "Customer[id=%d, name='%s', description='%s', age=%d, course='%s', password='%s', created=%s, updated=%s]",
                id, name, description, age, course, password, dataCreated, dataUpdated
        );
    }
