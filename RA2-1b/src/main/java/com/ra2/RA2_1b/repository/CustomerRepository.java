...
public class CustomerRepository {
    ...
    public void save(Customer customer) {
        ...
        String sql = "INSERT INTO customers (Name, Description, Age, Course, Password, dataCreated, dataUpdated) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public void update(Customer customer) {
        String sql = """
                UPDATE customers
                SET Name = ?, Description = ?, Age = ?, Course = ?, Password = ?, dataUpdated = ?
                WHERE id = ?
            """;
        jdbcTemplate.update(sql,
                customer.getName(),
